...
<!--          <el-menu router unique-opened>-->
        ...
        <el-main>
          ...
          <div class="homeWorkFlow" v-if="this.$router.currentRoute.path==='/home'">
            <a style="color: #3e9ef5" href="http://localhost:8082/workflow" >
              OA工作流系统点击跳转
            </a>
          </div>
...
.homeHeader {
  /*background: #3e9ef5;*/
  background-image: url("../assets/wallhaven-header.jpg");
  display: flex;
  align-items: center;
